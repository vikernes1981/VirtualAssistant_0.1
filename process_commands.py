...
from dictate import real_time_dictation  # Importing the new dictation function
...
def process_command(command):
    ...
    # Volume control commands
        ...
        speak("Please specify the website you want to open.", "Παρακαλώ καθόρισε την ιστοσελίδα που θέλεις να ανοίξεις.")
